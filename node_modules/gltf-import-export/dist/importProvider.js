...
function doConversion(sourceBuf, pathBase, targetFilename) {
    ...
    function writeImageBuf(images, bufferViewIndex, binBuffer) {
        ...
        const guess = (0, exportProvider_1.guessFileExtension)(firstReference.mimeType);
    ...
    function writeExtensionBuffer(buffers, bufferViewIndex, binBuffer) {
        ...
        const guess = (0, exportProvider_1.guessFileExtension)(firstReference.buffer.mimeType);
        const extension = guess.extension;
